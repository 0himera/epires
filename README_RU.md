...
Epires предоставляет AI-агентам 18 детерминированных инструментов:
...
| `epires_bulk_import` | Быстрый транзакционный импорт пачки гипотез и свидетельств за один вызов |
| `epires_export_graph` | Экспорт всей исследовательской памяти в переносимый JSON с SHA256-контрольной суммой |
| `epires_import_graph` | Воспроизводимый импорт графа знаний из JSON-бандла |
